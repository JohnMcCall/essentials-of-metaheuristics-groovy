...
class SymbolicRegressionSinXTests extends Specification {
	...
	// This test fails because we modified Tournament Selection to pick the largest instead of the smallest. 
	// But we're not going to use SymbolicRegressionSinX for this so it's fine
	
//	def "testing getPoints"() {
//		def problem = new SymbolicRegressionSinX([sizeLimit : 50])
